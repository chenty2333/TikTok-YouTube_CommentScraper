...
> [!IMPORTANT]
> 本仓库自 2026-07-11 起停止维护并归档，仅作为旧版本参考保留。
> 新的 TikTok 采集项目请使用 [TikTok Collector](https://github.com/chenty2333/tiktok-collector)：它提供本地优先的 WebUI、浏览器账号池、自适应查询规划、多 Worker 任务调度、数据溯源与导出。
> 新仓库专注于 TikTok 公开视频发现与研究，不包含本仓库的 YouTube 评论抓取功能。
